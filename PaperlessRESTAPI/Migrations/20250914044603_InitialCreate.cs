        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AIErrorMessage = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Tags",
                columns: new[] { "Id", "Color", "CreatedDate", "Description", "IsAIGenerated", "Name" },
                values: new object[,]
                {
                    { 1, "#dc3545", new DateTime(2025, 9, 14, 4, 46, 3, 747, DateTimeKind.Utc).AddTicks(9550), "Important documents", false, "Important" },
                    { 2, "#6c757d", new DateTime(2025, 9, 14, 4, 46, 3, 747, DateTimeKind.Utc).AddTicks(9550), "Archived documents", false, "Archive" },
                    { 3, "#28a745", new DateTime(2025, 9, 14, 4, 46, 3, 747, DateTimeKind.Utc).AddTicks(9560), "Invoice documents", false, "Invoice" },
                    { 4, "#007bff", new DateTime(2025, 9, 14, 4, 46, 3, 747, DateTimeKind.Utc).AddTicks(9560), "Contract documents", false, "Contract" },
                    { 5, "#fd7e14", new DateTime(2025, 9, 14, 4, 46, 3, 747, DateTimeKind.Utc).AddTicks(9560), "Report documents", false, "Report" }
                });
